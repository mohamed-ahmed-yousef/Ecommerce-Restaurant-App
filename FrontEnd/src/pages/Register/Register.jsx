...
const Register= () => {
    ...
    <>
        <div className = "parent">
            ...
            <h3 style={{color:"#4caf50", fontWeight:"bold", textAlign:'center'}}>Sing up</h3>
                
            <div className="username">
                <IconButton onClick={handleClickUserName}>
                    <PersonIcon style = {style} />
                </IconButton>
                <div className = "usernameParent">
                <TextField  inputRef={inputUserName} id="username" label="User Name" variant="outlined" {...register('username', {
                        required :
                        {
                            value:true,
                        ...
                        pattern:
                        {
                            ...
                            message: "Username must be 3-20 characters and only contain letters, digits, and underscores."
                          }
                

                    })} />
                    <p className = 'error'>{errors.username?.message &&  (
                         <>
                             <ErrorIcon color="warning"/> {errors.username?.message} 
                         </>
                    )}</p>
                    </div>
